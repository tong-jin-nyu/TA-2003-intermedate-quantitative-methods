...
### Modified on: 09/02/2020

# APSTA-GE 2003: Intermediate Quantitative Methods
# Fall 2020

# Lab 1 ------------------------------------------------------------------------
# Introduction to R, T Tests, and Simple Linear Regression
...
#    b. Use setwd(dir = "[folder path]") function to change working directory
#    **Best Practice**:
#      When calling a function, the first argument name can be hidden.
setwd(dir = "")
setwd("")

#    c. Use the "Files" tab to set the working directory with graphic UI. 
#    There is a small button with three dots at the upper right corner of the 
#    "Files" tab. It's called "Go to directory". After clicking, a file selection 
#    window will pop out, allowing you to change directory using graphic user 
#    interface. After locating the new directory, click "More" in the "Files" tab,
#    and then select "Set As Working Directory".
