...
# missing values.)
# Multiple R-squared (R^2) measures how well can model explain the variability of the 
# data. It is calculated as: MSS/TSS. The higher the R^2, the better the model 
# can explain the variability of data.
